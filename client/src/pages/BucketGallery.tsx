...
export default function BucketGallery() {
    const photos = [
        { id: 1, title: "Pumpkin Patch", desc: "Picked pumpkins!", date: "2025-09-01" },
        { id: 2, title: "Wedding Crash", desc: "At the beach wedding", date: "2025-09-10" },
        { id: 3, title: "Volleyball", desc: "Learned to serve", date: "2025-09-20" },
    ];
